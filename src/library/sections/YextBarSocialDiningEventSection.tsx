...
> = ({ id, ...props }) => {
  ...
  const bannerImage = hasBannerImage
  ...
  return (
    ...
    >
      ...
      >
        <style>{eventScopedTypographyCss}</style>
        <section
          ...
          >
            <div
              style={{
                ...
                minHeight: hasBannerImage ? "310px" : undefined,
                overflow: "hidden",
                position: "relative",
              }}
            >
              {hasBannerImage ? (
                <EntityField
                  ...
                  fieldId={props.bannerImage.image.field}
                  constantValueEnabled={
                    props.bannerImage.image.constantValueEnabled
                  }
                >
                  <Image
                    image={bannerImage!}
...
export const config: SectionConfig = {
  displayName: "Events",
  description: "Displays restaurant event content.",
  pageSetTypes: ["ENTITY"],
  category: "Content",
};
