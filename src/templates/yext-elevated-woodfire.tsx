...
const YextElevatedWoodfire: Template<TemplateRenderProps> = (props) => {
    const { document } = props;
    ...
    return (
        ...
        >
            <VisualEditorProvider templateProps={props}>
                <GTMBody>
                    <Render
                        config={YextElevatedWoodfireConfig}
                        data={data}
...
export default YextElevatedWoodfire;
