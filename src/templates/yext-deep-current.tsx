...
import { YextDeepCurrentConfig } from "../registry/yext-deep-current/config";
...
const YextDeepCurrent: Template<TemplateRenderProps> = (props) => {
    const { document } = props;
...
export default YextDeepCurrent;
