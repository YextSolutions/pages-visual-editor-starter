...
import { DunkinDonutsConfig } from "../registry/dunkin-donuts/config";
...
const DunkinDonuts: Template<TemplateRenderProps> = (props) => {
  const { document } = props;
