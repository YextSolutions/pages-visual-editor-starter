...
`;
export const YextElevatedWoodfireDetailsSection = createYextElevatedWoodfireSection(
  "Yext Elevated Woodfire Details Section",
  "details",
  ["section", "hours", "hoursStyles", "details"],
);
