...
`;
export const YextElevatedWoodfireFooterSection = createYextElevatedWoodfireSection(
  "Yext Elevated Woodfire Footer Section",
  "footer",
  ["section", "brandName", "socialLinks", "footer"],
);
