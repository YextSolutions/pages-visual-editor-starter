...
`;
export const YextElevatedWoodfireHeaderSection = createYextElevatedWoodfireSection(
  "Yext Elevated Woodfire Header Section",
  "header",
  ["section", "brandName", "headerLinks", "socialLinks"],
);
