...
type YextDeepCurrentStoryProps = {
  section: SectionTheme;
  content?: {
    sectionHeading: EditableText;
    paragraphs: { text: EditableText }[];
...
const SectionFields: YextFields<YextDeepCurrentStoryProps> = {
  section: {
    label: "Section",
    type: "object",
  ...
  content: {
    ...
    objectFields: {
      ...
      paragraphs: {
        ...
        label: "Paragraphs",
        defaultItemProps: {
          text: createEditableText("Paragraph text"),
        },
        arrayFields: {
  ...
  styles: {
    ...
    objectFields: {
      ...
      buttonTheme: createButtonThemeFields("CTA Colors"),
    },
  },
};

export const YextDeepCurrentStoryComponent: PuckComponent<YextDeepCurrentStoryProps> = (
  props,
) => {
  ...
  const primaryCta = resolveCta(
    content?.primaryCta ?? props.primaryCta,
    locale,
    streamDocument,
  );
  const buttonClass = `yext-deep-current-story-button-${props.id}`;
  ...
  return (
    ...
    >
      <AnalyticsScopeProvider
        name={`YextDeepCurrentStory${getAnalyticsScopeHash(props.id)}`}
      >
        <style>{buttonThemeToStylesheet(buttonClass, styles?.buttonTheme ?? props.buttonTheme ?? defaultPrimaryButtonTheme)}</style>
        <section
          id="about"
            ...
            <div className="mx-auto max-w-[980px]">
              ...
              >
                {resolveText(
                  ...
                  locale,
                  streamDocument,
                  "About Northstar Wealth Partners - Uptown Charlotte",
                )}
              </h2>
              <div
              ...
              >
                {(content?.paragraphs ?? props.paragraphs ?? []).map((paragraph, index) => (
                  <p key={index}>
                    {resolveText(
                      paragraph.text,
                      locale,
              ...
              {primaryCta ? (
                <div className="mt-8">
                  ...
                  >
                    <span
                      className={`inline-flex min-h-[42px] items-center rounded-[10px] border px-7 py-2.5 text-sm font-bold transition-colors ${buttonClass}`}
                      style={{
                        color: textColors.buttonTextColor,
                        ...buttonThemeToCss(styles?.buttonTheme ?? props.buttonTheme ?? defaultPrimaryButtonTheme),
...
export const YextDeepCurrentStory: YextComponentConfig<YextDeepCurrentStoryProps> = {
  label: "Deep Current About",
  ...
  defaultProps: {
    ...
    content: {
      sectionHeading: createEditableText(
        "About Northstar Wealth Partners - Uptown Charlotte",
      ),
      paragraphs: [
        {
          text: createEditableText(
            "Northstar Wealth Partners - Uptown Charlotte is located in the South Tryon district near Uptown Charlotte and supports clients across Mecklenburg County and surrounding communities. The office provides in-person and virtual financial planning conversations for individuals, families, retirees, and business owners looking for guidance around long-term financial goals.",
          ),
        },
        {
          text: createEditableText(
      ...
      primaryCta: createEditableLink("Book Appointment", "#"),
    },
    styles: {
      headingStyle: defaultTextStyle,
      bodyStyle: defaultTextStyle,
      buttonStyle: defaultButtonStyle,
      buttonTheme: defaultPrimaryButtonTheme,
    },
  },
  render: YextDeepCurrentStoryComponent,
};
