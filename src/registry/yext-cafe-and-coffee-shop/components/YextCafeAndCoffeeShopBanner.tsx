...
type YextCafeAndCoffeeShopBannerProps = {
  data: {
...
const YextCafeAndCoffeeShopBannerFields: YextFields<YextCafeAndCoffeeShopBannerProps> = {
  data: {
    label: "Banner Text",
    type: "object",
    objectFields: {
...
const YextCafeAndCoffeeShopBannerComponent: PuckComponent<YextCafeAndCoffeeShopBannerProps> = ({
  data,
  styles,
  section,
  puck,
 ...
 */
export const YextCafeAndCoffeeShopBanner: YextComponentConfig<YextCafeAndCoffeeShopBannerProps> = {
  label: "Banner",
  fields: toPuckFields(YextCafeAndCoffeeShopBannerFields),
  defaultProps: {
    data: {
      text: {
        field: "",
  ...
  render: (props) => (
    ...
    >
      <YextCafeAndCoffeeShopBannerComponent {...props} />
    </VisibilityWrapper>
  ),
};
