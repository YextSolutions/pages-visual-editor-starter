...
export const YetiHeaderSectionComponent: PuckComponent<YetiHeaderSectionProps> = (
  ...
  return (
    ...
    >
      <div className="hidden bg-[#002b45] text-white xl:block">
        <div
          className="mx-auto flex min-h-[60px] max-w-[1540px] items-center justify-between px-10"
        >
          <div className="ml-[146px] flex items-center gap-[45px]">
          ...
          <div className="mr-10 flex items-center gap-[14px]">
      ...
      <div className="border-b border-[#ddd]">
        <div
          className="mx-auto flex min-h-[72px] max-w-[1540px] items-center justify-between bg-white px-5 xl:min-h-[80px] xl:px-10"
        >
          <p
          ...
          <div className="mx-[30px] hidden flex-1 items-center justify-center gap-[30px] xl:flex">
            {props.primaryNavigation.map((item, index) => {
              ...
              if (isChip) {
                return (
                  <div
                    key={item.label}
                    className="rounded-[4px] border border-[#f4b44e] px-[14px] py-[7px]"
                    style={{
                      color: "#002b45",
                      fontFamily: "'stratum-1-web', 'Barlow Condensed', sans-serif",
                      fontSize: "12px",
              ...
              return (
                <div className="relative" key={item.label}>
                  ...
                  >
                    {item.label}
                    <span
                      className="absolute left-1/2 bottom-[-20px] h-[3px] -translate-x-1/2 bg-[#002b45] transition-[width] duration-200"
                      style={{
                        width: isActive ? "100%" : "0",
                        transitionTimingFunction: "cubic-bezier(.37,0,.63,1)",
                      }}
                    />
                  </p>
                </div>
          ...
          <div className="flex items-center gap-[14px] xl:gap-[18px]">
            <div
              className="hidden w-[170px] items-center rounded-[2px] border border-[#ddd] px-3 py-2 text-[#8a8a8a] xl:flex"
            >
              <p className="mr-[10px]">⌕</p>
              <p style={{ fontSize: "14px", fontFamily: "'urw-din', 'Oswald', sans-serif" }}>
                Search ...
              </p>
            </div>
            <p style={{ color: "#002b45", fontSize: "18px" }}>
              👜
            </p>
            <p style={{ color: "#002b45", fontSize: "18px" }}>
              👤
      ...
      {activeIndex !== null &&
        ...
        props.primaryNavigation[activeIndex].groups.length > 0 && (
          <div
            className="absolute left-0 right-0 top-full hidden border-b border-[#ddd] bg-[rgba(255,255,255,0.94)] xl:block"
            style={{ backdropFilter: "blur(40px)" }}
          >
            <div
              className="mx-auto flex max-w-[1540px] items-start justify-between gap-[25px] px-10 py-10"
            >
              <div className="flex flex-1 justify-center gap-[25px]">
                {props.primaryNavigation[activeIndex].groups.map((group) => (
                  <div className="max-w-[165px]" key={`${props.primaryNavigation[activeIndex].label}-${group.label}`}>
                    {group.href ? (
                      <p
                        className={group.children.length ? "mb-[10px]" : ""}
                        style={{
                          color: "#002b45",
                          fontFamily: "'urw-din', 'Oswald', sans-serif",
                          fontSize: "16px",
              ...
              {props.primaryNavigation[activeIndex].promo && (
                <div
                  className="flex min-h-[255px] flex-[0_0_255px] items-end overflow-hidden rounded-[6px] bg-[#002b45]"
                  style={{
