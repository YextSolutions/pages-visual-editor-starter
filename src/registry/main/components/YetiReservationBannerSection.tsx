  ...
  return (
    <section className="relative h-[420px] overflow-hidden md:h-[500px]">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, rgba(0, 0, 0, 0.65) 0%, rgba(0, 0, 0, 0.3) 28%, rgba(0, 0, 0, 0) 58%)",
        }}
      />
      <div className="relative z-[1] flex h-full items-end px-[35px] pb-[55px] md:px-[75px]">
        <div className="max-w-[280px] md:max-w-[410px]">
          <p
            className="text-[42px] tracking-[3px]"
            style={{
          ...
          <p
            className="mb-6 mt-[10px] max-w-[290px] text-[14px] md:max-w-[360px]"
            style={{
