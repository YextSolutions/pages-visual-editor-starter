  ...
  return (
    ...
    >
      ...
      <Box
        position="absolute"
        inset={0}
        bg="linear-gradient(90deg, rgba(0, 0, 0, 0.55) 0%, rgba(0, 0, 0, 0.32) 28%, rgba(0, 0, 0, 0) 60%)"
      />
      <Box
        position="relative"
        zIndex={1}
        ...
        display="flex"
        alignItems="center"
        px={{ base: "32px", md: "75px" }}
      >
        <Box maxW={{ base: "280px", md: "430px" }}>
          <Text
            color={props.heading.fontColor}
            fontFamily="'stratum-1-web', 'Barlow Condensed', sans-serif"
            fontSize={{ base: "45px", md: `${props.heading.fontSize}px` }}
            fontWeight={props.heading.fontWeight}
            lineHeight={{ base: "47px", md: "53px" }}
          ...
          <Text
            ...
            fontSize={{ base: "16px", md: `${props.body.fontSize}px` }}
